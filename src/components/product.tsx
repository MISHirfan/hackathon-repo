        ...
        {[
          {
            ...
            price: "Rs. 25,000.00",
            image: "/modulasofa.png", // Replace with actual image paths
          },
          {
            id: 2,
            name: "Granite dining table with dining chair",
            price: "Rs. 25,000.00",
            image: "/granitediningtable.png", // Replace with actual image paths
          },
          {
            id: 3,
            name: "Outdoor bar table and stool",
            price: "Rs. 25,000.00",
            image: "/Outdoorbartable.png", // Replace with actual image paths
          },
          {
            id: 4,
            name: "Plain console with teak mirror",
            price: "Rs. 25,000.00",
            image: "/Plainconsole.png", // Replace with actual image paths
          },
        ].map((product) => (
          <div
            key={product.id}
